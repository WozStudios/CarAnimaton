#ifndef FENCE_BOARD_H
#define FENCE_BOARD_H

#include "IGameObject.h"
#include "IDrawable.h"
#include "Transform.h"

class FenceBoard : public IGameObject, public IDrawable
{
private:
...
public:
	FenceBoard(vec3 position, float rotationAngle, vec3* cameraPosition, vec3* cameraDirection);
